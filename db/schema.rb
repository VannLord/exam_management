...
ActiveRecord::Schema.define(version: 2021_05_27_084505) do
  ...
  create_table "exam_questions", charset: "utf8mb3", force: :cascade do |t|
    t.integer "score"
    t.bigint "question_id", null: false
  ...
  create_table "user_exam_answers", charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "user_exam_statistic_details", charset: "utf8mb3", force: :cascade do |t|
    t.integer "count"
    t.bigint "subject_id", null: false
  ...
  create_table "user_exam_statistics", charset: "utf8mb3", force: :cascade do |t|
    t.datetime "date"
  ...
  create_table "user_exams", charset: "utf8mb3", force: :cascade do |t|
